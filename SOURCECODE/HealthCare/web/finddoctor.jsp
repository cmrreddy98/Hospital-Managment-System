...
%>
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <h2 align="right"><FONT COLOR="#ffSS">Find Best Doctor</FONT></h2>
    ...
    <div class="row_1">
        <div class="container">
            ...
            <div class="row" style="margin-left: 200px">
                <ul class="list1">
                    <li class="col-lg-3 col-md-3 col-sm-6 col-xs-6 collist1">
                        <a class="maxheight" href="localsearch.jsp">
                            <strong>Locality search</strong>
                            <span></span>
                          
                        </a>
                    </li> 
                    <li class="col-lg-3 col-md-3 col-sm-6 col-xs-6 collist1">
                        <a class="maxheight" href="spesearch.jsp">
                    ...
                    <li class="col-lg-3 col-md-3 col-sm-6 col-xs-6 collist1">
                        <a class="maxheight" href="diseasesearch.jsp">
                            <strong>Disease Search</strong>
                           <span></span>
                        </a>
                    </li>                 
                </ul>
