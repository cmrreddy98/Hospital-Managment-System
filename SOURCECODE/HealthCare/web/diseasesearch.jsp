...
<header id="header">
  <div class="headertop">
    <div class="container">
       <h1 class="navbar-brand navbar-brand_"><a href="index.html"><img src="images/cooltext174660417311515.png" alt=""></a></h1>
      <div class="rightside">
...
%>
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <h2 align="right"><FONT COLOR="#ffSS">Welcome's Disease Search</FONT></h2>
            
                    
                  <form id="form1" name="form1" method="post" action="doDiseases.jsp" onsubmit="return valid()"><br />
	<table  width="501" border="0" align="right" style="background-color: greenyellow;" cellpadding="2" cellspacing="2" style=" padding: 5px;" height="183">
            <tr>
              <th colspan="3" bgcolor="#000000" scope="col" style="background-color: rgb(328, 128, 64);"><font color="#FFFFFF"> Disease Search Form </font></th>
              </tr>
            
            <tr >
              <td style="background-color:greenyellow;"><div align="center"><font color="#ff0000"><b>Select Disease:</div></td>
...
%>
<option value="<%=rssa.getString("specialist")%>"><%=rssa.getString("specialist")%></option>
<%
}
}
catch(Exception ex)
