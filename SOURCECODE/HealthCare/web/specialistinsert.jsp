...
PreparedStatement ps=con.prepareStatement("select id from specialists");
...
ArrayList list = new ArrayList();
		...
		String image=null;String unamee=null,fee=null,experience=null,specialist=null;
			...
			while (params.hasMoreElements()) 
			{
                                ...
                                if(paramname.equalsIgnoreCase("location"))
				{
				       gender=multi.getParameter(paramname);
                                ...
                                if(paramname.equalsIgnoreCase("experience"))
				{
				       experience=multi.getParameter(paramname);
				}
                                if(paramname.equalsIgnoreCase("fee"))
				{
				       fee=multi.getParameter(paramname);
				}
                                if(paramname.equalsIgnoreCase("specialist"))
				{
				       specialist=multi.getParameter(paramname);
				}
	...
	while (files.hasMoreElements()) 
	{
		...
		if(paramname != null)
		{
	        ...
	        FileInputStream fs1 = null;
                ...
                PreparedStatement sql =con.prepareStatement("INSERT INTO specialists VALUES ('"+u3+"','"+unamee+"','"+question+"','"+answer+"','"+address+"','"+mobile+"','"+age+"','"+gender+"','"+experience+"',?,'"+fee+"','"+specialist+"','"+email+"')");
...
<p>&nbsp;</p>	</td>
	...
	if(x!=0)
        {
	response.sendRedirect("specialists.jsp?message=succ");
	}else {
	%>
	<font color="#FF0000">Sorry!. Registration<th colspan="3" scope="col" ><font size="6" color="#800080" face="Mistral"><img border="0" src="images/hc.ico" width="92" height="75"/>n is not created.<br/>Click Here to <a href="specialists.jsp">Register Again</a></font>
	<%
	}
	 %>
	</div>
