            ...
            <nav class="navbar navbar-default navbar-static-top tm_navbar" role="navigation">
                <ul class="nav sf-menu">
                  ...
                  <li class="active"><a href="AvailableAppointment.jsp">New Appointments</a></li>
                       ...
                       <li class="active"><a href="staffregister.jsp">Create New Doctor</a></li>
                        <li class="active"><a href="specialists.jsp">Create New Specialists</a></li>
                              <li class="active"><a href="ViewDoctors.jsp">View Doctors</a></li>
                              <li class="active"><a href="viewspecialists.jsp">View Specialists</a></li>
...
%>
                <div >
                    <h2 align="center"><FONT COLOR="yellow">Welcome to Administrator Page</FONT><br>
                    <img src="images/myfile.png"></h2>
