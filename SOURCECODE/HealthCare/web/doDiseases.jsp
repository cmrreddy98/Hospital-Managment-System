...
ResultSet rs1 = st1.executeQuery("select * from  doctors where specialist='"+kk+"'");
while(rs1.next()){
       %>   
      <tr bgcolor="#e0e0e0"> 
...
<td align="center"><strong><font  color="#00aaff"> <img src="docimage.jsp?<%=rs1.getString(1)%>" height="50" width="50"> </font></strong></td>
