...
%>
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <h2 align="right"><FONT COLOR="#ffSS">Welcome's Locality Search</FONT></h2>
                    
                 
                  
                  <form id="form1" name="form1" method="post" action="doLocations.jsp" onsubmit="return valid()"><br />
	<table  width="401" border="0" align="right" style="background-color: greenyellow;" cellpadding="2" cellspacing="2" style=" padding: 5px;" height="183">
            <tr>
            ...
            <tr >
              <td style="background-color:greenyellow;"><div align="center"><font color="#ff0000"><b>Select Location:</div></td>
...
{
%>
<option value="<%=rssa.getString(8)%>"><%=rssa.getString(8)%></option>
<%
}
}
catch(Exception ex)
