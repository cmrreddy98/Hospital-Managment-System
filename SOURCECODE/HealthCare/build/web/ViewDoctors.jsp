...
ResultSet rs1 = st1.executeQuery("select * from  doctors");
while(rs1.next()){
       %>   
      <tr bgcolor="white"> 
<td align="center"> <strong><font color="blue"> <%=rs1.getString(1)%> </font></strong></td>
              ...
              <td align="center"><strong><font  color="blue"> <img src="docimage.jsp?<%=rs1.getString(1)%>" height="50" width="50"> </font></strong></td>
             ...
             <td align="center"><strong><font  color="blue"> <%=rs1.getString(13)%> </font></strong></td>
              <td align="center"><strong><font  color="blue">Rs. <%=rs1.getString(11)%> </font></strong></td>
             <td align="center"><strong><a href="deleteuser.jsp?<%=rs1.getString(1)%> "><font  color="green">Delete</font></a></strong></td>
