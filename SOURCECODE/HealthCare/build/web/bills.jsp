...
<div id="content">
    ...
    <div class="row_7">
        <div class="container">
            <h2 align="center"><font color="yellow">Bill Generation Form</font></h2>
            <div class="row" style="margin-left: 200px">
                <ul class="list1">
                    <li class="col-lg-3 col-md-3 col-sm-6 col-xs-6 collist1">
                        <a class="maxheight" href="pbill.jsp?pbill">
                            <strong>Patient Bills</strong>
                            
                            <span></span>
                        </a>
                    </li> 
                    <li class="col-lg-3 col-md-3 col-sm-6 col-xs-6 collist1">
                        <a class="maxheight" href="rbill.jsp">
                            <strong>Room Wise Bills</strong>
                           
                            <span></span>
                        </a>
                    </li> 
                    <li class="col-lg-3 col-md-3 col-sm-6 col-xs-6 collist1">
                        <a class="maxheight" href="wbill.jsp">
                            <strong>Wards wise Bills</strong>
