...
%>
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                   ...
                   <font color="yellow"> <h4> View Specialist List  </h4></font><br>
           ...
           <tr bgcolor="#ff9900"> 
              ...
              <td align="center"> <font color="#110022"><strong>Qualification</strong></font></td>
              ...
              <td align="center"><font color="#110022"><strong>Certificate</strong></font></td>
              <td align="center"> <font color="#110022"><strong>Phone</strong></font></td>
             
               <td align="center"> <font color="#110022"><strong>Working in</strong></font></td>
...
ResultSet rs1 = st1.executeQuery("select * from  specialists where name='"+kk+"'");
while(rs1.next()){
...
<td align="center"> <strong><font color="#00aaff"> <%=rs1.getString(1)%> </font></strong></td>
              ...
              <td align="center"><strong><font  color="#00aaff"> <%=rs1.getString(6)%> </font></strong></td>
              ...
              <td align="center"><strong><font  color="#00aaff"> <%=rs1.getString(9)%> </font></strong></td>
             
               <td align="center"><strong><font  color="#00aaff"> <img src="image1.jsp?<%=rs1.getString(1)%>" height="50" width="50"> </font></strong></td>
                   <td align="center"><strong><font  color="#00aaff"> <%=rs1.getString(7)%> </font></strong></td>
             <td align="center"><strong><font  color="#00aaff"> <%=rs1.getString("reco")%> </font></strong></td>
