        ...
        <div class="container">
            <div class="row" style="margin-left: 100px;">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <h2><FONT COLOR="#FFDDSS">Rooms Registration Form</FONT></h2>
                    
                 

		<table  width="680" height="350" style="width: 800px;height:400px;border-radius: 20px;margin-top: 10px;background: khaki">
		
		<tr><td><img src="images/serviceicon-8.png" height="200" width="400"></td><td>
		<form name="form" action="roominsert.jsp" method="post"  onsubmit="return validation()">
              ...
              <table  align="right" height="250" width="550" >
                <tr> 
                  <td colspan="2" align="center"><font size="2"><b> 
                     <%
                                                       ...
                                                       {
                                                               out.println("<script>alert('Room is Added..!!')</script>");
                                                       }
                                                       if(messages!=null && messages.equalsIgnoreCase("same"))
                                                       {
                                                               out.println("<script>alert('Sorry!!  Room is Already Existed..!!')</script>");
				...
				<tr> 
                  <td><font  color="blue"><strong>Room Number:</strong></font></td>
                  <%Random rr=new Random();int rnumber=rr.nextInt(1000);%>
                  <td><input type="text" name="name" value="<%=rnumber%>" readonly></td>
                </tr>
                
                <tr> 
                  <td><font color="blue"><strong>Room Charges:</strong></font></td>
                  <td><input type="text" name="age"></td>
                </tr>
				<tr> 
                  <td><font color="blue"><strong>Room Type:</strong></font></td>
                  <td><input type="radio"  name="gender" value="General"> <font color="green"><strong>General</strong></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="gender" value="Deluxe"> <font color="green"><strong>Deluxe</strong></font></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td><font color="blue"><strong>Room Name:</strong></font></td>
                  <td><input type="text" name="pname"></td>
                </tr>
                
                <tr>
                  <td></td>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" value="Add Room" class="sub">
                  </td>
                </tr>
              </table>
