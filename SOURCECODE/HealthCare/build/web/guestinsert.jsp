...
PreparedStatement ps=con.prepareStatement("select id from doctors");
	...
	while (files.hasMoreElements()) 
	{
		...
		if(paramname != null)
		{
	        ...
	        FileInputStream fs1 = null;
                ...
                PreparedStatement sql =con.prepareStatement("INSERT INTO doctors VALUES ('"+u3+"','"+unamee+"','"+question+"','"+answer+"','"+address+"','"+mobile+"','"+age+"','"+gender+"',?,'"+email+"','"+fee+"','"+experience+"','"+specialist+"')");
...
<p>&nbsp;</p>	</td>
	...
	if(x!=0)
        {
	response.sendRedirect("staffregister.jsp?message=succ");
	}else {
	%>
	<font color="#FF0000">Sorry!. Registration<th colspan="3" scope="col" ><font size="6" color="#800080" face="Mistral"><img border="0" src="images/hc.ico" width="92" height="75"/>n is not created.<br/>Click Here to <a href="staffregister.jsp">Register Again</a></font>
	<%
	}
	 %>
	</div>
